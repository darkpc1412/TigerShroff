...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ ɢʀᴏᴜᴘ ⭕️", url="https://t.me/mnxmovies124"),
                InlineKeyboardButton("⭕️ ᴅᴇᴠ ⭕️", url="https://t.me/Justinvrgs")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
        [
            InlineKeyboardButton('𝑮𝒓𝒐𝒖𝒑', url='https://t.me/mnxmovies124'),
            InlineKeyboardButton('𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓', url='https://t.me/Justinvrgs')
        ],
        [
            InlineKeyboardButton('𝑪𝒉𝒂𝒏𝒏𝒆𝒍', url=f'https://t.me/movieclub1241')
        ]
        ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴅᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/Justinvrgs'),
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/mnxmovies124')
            ],[
            InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ', url='https://t.me/movieclub1241'),
            ],[
        ...
        buttons= [[
            ...
            InlineKeyboardButton('🍿ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ🍿', url='https://t.me/mnxmovies124')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="🎀 ᴊᴏɪɴ ᴏᴜʀ ᴄᴀɴɴᴇʟ 🎀",url="https://t.me/movieclub1241")]
        )
    else:
        btn.append(
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="🎀 ᴊᴏɪɴ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ 🎀",url="https://t.me/movieclub1241")]
        )
