...
║╭━━━━━━━━━━━━━━━➣ 
║➠ 𝙼𝚈 𝙽𝙰𝙼𝙴 -  ѕнα∂σω
║➠ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁 - :<a href='https://t.me/Justinvrgs'><b>𝕵𝖚𝖘𝖙𝖎𝖓</b></a>
...
║➠ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴 -  <a href='https://t.me/mnxmovies124'>𝑯𝒆𝒓𝒐𝒌𝒖</a>
║➠ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂 - <a href='https://t.me/saniyaiyappanbot'>𝒗8.7.2[𝑴𝒂𝒋𝒐𝒓]</a>
...
/hand <anything> to Get the Photo"""
 ...
 Tʜᴇɴ Mᴀʟʟᴜ Aᴜɴᴛʏ Wɪʟʟ Tᴇxᴛ Yᴏᴜ Sᴏᴍᴇ Jᴏᴋᴇs 😂😂 """
    ...
    ABOUTME_TXT = """➢ 𝐌𝐲 𝐍𝐚𝐦𝐞: <a href='http://t.me/manjuwarrierv1_bot'>ѕнα∂σω </a>
...
➢ 𝐌𝐲 𝐒𝐞𝐫𝐯𝐞𝐫: <a href='https://t.me/mnxmovies124'>𝖧𝖾𝗋𝗈𝗄𝗎</a>

➢ 𝐌𝐲 𝐔𝐩𝐝𝐚𝐭𝐞𝐬: <a href='https://t.me/mnxmovies124'>𝐌𝐎𝐕𝐈𝐄 𝐂𝐋𝐔𝐁 📺🎥</a>

➢ 𝐌𝐲 𝐒𝐮𝐩𝐩𝐨𝐫𝐭: <a href='https://t.me/saniyaiyappanbot'>𝖲𝗎𝗉𝗉𝗈𝗋𝗍</a>
...
<b>NOTE:</b>
• ѕнα∂σω should have admin privillage.
...
- Filter is the feature were users can set automated replies for a particular keyword and ѕнα∂σω  will respond whenever a keyword is found the message

<b>NOTE:</b>
1. ѕнα∂σω should have admin privillage.
...
• ѕнα∂σω should have admin privillage.
• These commands works on both pm and group.
• ѕнα∂σω can translate texts to 200+ languages."""
    PINGS_TXT ="""<b>🌟 Ping:</b>
...
-ѕнα∂σω Supports both url and alert inline buttons.

<b>NOTE:</b>
1. Telegram will not allows you to send buttons without any content, so content is mandatory.
2. ѕнα∂σω supports buttons with any telegram media type.
